...
<html lang="en">
  <head>
    ...
    <!-- META INFO -->
    <meta name="description" content="Need to build a new website or just do a revamp? Look no further! Specialized in Bootstraping along with Wordpress/Woocommerce for your online shops and custom projects.">
    ...
    <?php include_once("php/analyticstracking.php") ?> <!-- GOOGLE ANALYTICS -->
   </head>
